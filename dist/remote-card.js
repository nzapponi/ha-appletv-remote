...
let AppleTVRemoteEditor = class AppleTVRemoteEditor extends LitElement {
    setConfig(config) {
        this._config = config;
    }
    get _name() {
...
__decorate([
    property()
], AppleTVRemoteEditor.prototype, "hass", void 0);
__decorate([
    property()
], AppleTVRemoteEditor.prototype, "_config", void 0);
__decorate([
    property()
], AppleTVRemoteEditor.prototype, "_toggle", void 0);
AppleTVRemoteEditor = __decorate([
...
const getActionHandler = () => {
    ...
    if (body.querySelector('action-handler-apple-tv-remote')) {
        return body.querySelector('action-handler-apple-tv-remote');
    }
...
let AppleTVRemote = class AppleTVRemote extends LitElement {
    static async getConfigElement() {
        return document.createElement('apple-tv-remote-editor');
    }
    ...
    setConfig(config) {
        ...
        this._config = Object.assign({ name: 'Apple TV Remote' }, config);
    }
    shouldUpdate(changedProps) {
        return Y(this, changedProps, false);
    }
    render() {
      ...
      <ha-card
        ...
        tabindex="0"
        aria-label=${`Apple TV: ${this._config.entity}`}
      ></ha-card>
    `;
    }
    _handleAction(ev) {
...
__decorate([
    property()
], AppleTVRemote.prototype, "hass", void 0);
__decorate([
    property()
], AppleTVRemote.prototype, "_config", void 0);
AppleTVRemote = __decorate([
    customElement('apple-tv-remote')
], AppleTVRemote);

export { AppleTVRemote };
